        ...
        Row(
            ...
            Switch(
                ...
                colors = SwitchDefaults.colors(
                    ...
                    checkedTrackColor = colorResource(id = R.color.color_switch_enabled),
                    checkedBorderColor = colorResource(id = R.color.color_switch_enabled),
                    uncheckedBorderColor = colorResource(id = R.color.color_switch_disabled),
                ),
                onCheckedChange = {
                    checked = it
                    onCheckedChange(it)
